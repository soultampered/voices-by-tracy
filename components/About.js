...
const About = ({auditionBtn}) => {
    ...
    return (
        <section id="aboutSection" className="rounded-t-3xl lg:py-6 lg:px-8 border-t border-neutral-800 pt-8">
                    ...
                    <div className="grid lg:grid-cols-[1.4fr_1fr] gap-8 lg:gap-10 items-start">
                        ...
                        <div className="flex justify-center">
                            <Image src="/resources/images/leithBust.jpg"
                                className='rounded-3xl w-full max-w-xs lg:max-w-none object-cover'
                                alt="Tracy Photo"
