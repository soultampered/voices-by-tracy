...
const WhyChoose = () => {
    ...
    return (
        <section>
            <div id="features" className="relative block pr-6 py-6">
                <div className="relative mx-auto max-w-5xl text-center">
                    <h2 id="serviceSection" className="block w-full bg-gradient-to-b from-white to-gray-400 bg-clip-text font-bold text-transparent text-3xl sm:text-4xl">{t('services:marketing-slogan')}</h2>
                        ...
                        {whyChooseData[0].reason.map((reason) => (
                            ...
                            <span className="text-violet-600 bg-violet-500/10 p-3 rounded-full">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-gray-500">{t(`services:${reason.desc}`)}</p>
                                </div>
                            </div>
                        ))}
