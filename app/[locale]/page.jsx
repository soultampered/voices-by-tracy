        ...
        <TranslationsProvider resources={resources} locale={locale} namespaces={i18nNamespaces}>
            <div className="bg-whiteWash h-screen flex items-center justify-center relative">
                ...
                <div className="m-auto">
                    <div>
                        <div className="bg-gradient rounded-3xl relative shadow-2xl p-4 border-2 landscape-width w-[90vw] h-[90vh] max-w-[1080px] max-h-[720px] flex flex-col items-center justify-center">
